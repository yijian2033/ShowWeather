...
public class CityListAdapter extends BaseRecyclerViewAdapter<CityListAdapter.ViewHolder> implements Filterable {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        String root = city.getRoot();
        /*if (!cityName.equals(parentName)) {
            cityName = parentName + "." + cityName;
        }*/
        if (SelectCityFragment.currentLevel == 1)
            holder.cityNameTextView.setText(root);
        else if(SelectCityFragment.currentLevel == 2)
            holder.cityNameTextView.setText(parentName);
        else //if(SelectCityFragment.currentLevel == 3)
