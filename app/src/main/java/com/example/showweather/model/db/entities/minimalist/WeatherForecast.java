...
public class WeatherForecast {
    ...
    private static final String HUM_FIELD_NAME = "hum";
    private static final String PRES_FIELD_NAME = "pres";
    ...
    @DatabaseField(columnName = HUM_FIELD_NAME)
    private String hum;
    @DatabaseField(columnName = PRES_FIELD_NAME)
    private String pres;
    ...
    public WeatherForecast(String cityId, String weather, String weatherDay, String weatherNight,
                           int tempMax, int tempMin, String wind, String data, String week,String hum, String pres) {
